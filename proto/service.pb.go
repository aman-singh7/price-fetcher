...
var fileDescriptor_c33392ef2c1961ba = []byte{
	...
	0x58, 0x0b, 0x40, 0x0a, 0x25, 0x98, 0x14, 0x18, 0x35, 0x18, 0x83, 0x20, 0x1c, 0x23, 0x6b, 0xa8,
	0x35, 0x6e, 0xa9, 0x25, 0xc9, 0x19, 0xa9, 0x45, 0x42, 0xda, 0x5c, 0x5c, 0x60, 0x26, 0x58, 0x50,
	0x88, 0x57, 0x0f, 0xd9, 0x0d, 0x52, 0x7c, 0x7a, 0x28, 0x56, 0x39, 0xb1, 0x47, 0xb1, 0x82, 0x1d,
	0x9b, 0xc4, 0x06, 0xa6, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xa7, 0x8b, 0xa7, 0x5b, 0xca,
	0x00, 0x00, 0x00,
}
...
// UnimplementedPriceFetcherServer can be embedded to have forward compatible implementations.
type UnimplementedPriceFetcherServer struct {
}

func (*UnimplementedPriceFetcherServer) FetchPrice(ctx context.Context, req *PriceRequest) (*PriceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FetchPrice not implemented")
}

func RegisterPriceFetcherServer(s *grpc.Server, srv PriceFetcherServer) {
